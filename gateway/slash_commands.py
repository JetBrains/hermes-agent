        ...
        if is_create and output:
            ...
            if m:
                ...
                try:
                    ...
                    # ``chat_type`` (read above) is persisted on the sub so a
                    # woken turn keys to this channel instead of a parallel
                    # session, and is replayed in the delivery metadata.
